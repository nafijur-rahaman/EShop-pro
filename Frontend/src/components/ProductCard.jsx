...
import { useAuth } from "../hook/useAuth"; // make sure your auth hook provides user state and login status
...
export default function ProductCard({ product }) {
  ...
  const handleAddToCart = () => {
    ...
    // Here you can call your cart API or context method to add the product
    // Example:
    // addToCart(product);
